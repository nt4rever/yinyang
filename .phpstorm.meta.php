...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'eloquentfilter.paginate_limit' => 'string',
            ...
            'filesystems.links./home/tannnguci/code/yinyang/public/storage' => 'string',
            ...
            'repository.users.ttl' => 'integer',
            'repository.users.prefix' => 'string',
            'repository.personal_access_tokens.ttl' => 'integer',
            'repository.personal_access_tokens.prefix' => 'string',
...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','eloquentfilter.namespace','eloquentfilter.paginate_limit',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/tannnguci/code/yinyang/public/storage','logging.default','logging.deprecations.channel',
...
'logging.channels.single.path','logging.channels.single.level','logging.channels.single.replace_placeholders','logging.channels.single.permission','logging.channels.daily.driver',
...
'queue.failed.table','repository.users.ttl','repository.users.prefix','repository.personal_access_tokens.ttl','repository.personal_access_tokens.prefix',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','boost.browser_logs_watcher','reverb.default',
...
'reverb.apps.apps.0.allowed_origins','reverb.apps.apps.0.ping_interval','reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_message_size','ide-helper.filename',
...
'telescope','verification.verify','storage.local',);
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','auth.email_not_verified',);
...
'MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','AWS_ENDPOINT','AWS_ACCESS_KEY_ID',
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME',
'PAGINATION_LIMIT_DEFAULT','OCTANE_SERVER','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET',
