...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/tanlv/code/yinyang/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/tanlv/code/yinyang/public/storage','logging.default','logging.deprecations.channel',
...
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','repository.users.ttl',
'repository.users.prefix','repository.personal_access_tokens.ttl','repository.personal_access_tokens.prefix','sanctum.stateful','sanctum.guard',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','boost.browser_logs_watcher','reverb.default','reverb.servers.reverb.host','reverb.servers.reverb.port',
...
'reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_message_size','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'PAGINATION_LIMIT_DEFAULT','OCTANE_SERVER',);
